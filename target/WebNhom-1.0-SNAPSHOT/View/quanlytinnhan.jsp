                                ...
                                <div class="table-responsive">
                                    <table class="table">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                Giao hàng trong bao lâu ạ
                                            </td>
                                            <td class="text-primary">
                                                <i class="fas fa-edit" style="margin-right:4px; font-size: 20px;margin-left:16px;"></i> <i class="fas fa-trash-alt" style="font-size: 20px; color: red;"></i>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                            ...
                                            <td>
                                                <img width="50px" height="50px" src="../assets/img/2_53555-RGMWRG-2-399x399.png" alt="">
                                            </td>
                                            <td>
                                                Minerva Hooper
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <img width="50px" height="50px" src="../assets/img/2_LTP-E165D-1ADF.png" alt="">
                                            </td>
                                            <td>
                                                Sage Rodriguez
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <img width="50px" height="50px" src="../assets/img/4_OR-LOVE-399x399.png" alt="">
                                            </td>
                                            <td>
                                                Philip Chaney
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <img width="50px" height="50px" src="../assets/img/5_OR-STAR-399x399.png" alt="">
                                            </td>
                                            <td>
                                                Doris Greene
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <img width="50px" height="50px" src="../assets/img/7_OR-2-399x399.png" alt="">
                                            </td>
                                            <td>
                                                Mason Porter
                                            </td>
