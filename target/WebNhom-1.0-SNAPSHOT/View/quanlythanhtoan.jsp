        ...
        <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
            <div class="container-fluid">
                <div class="navbar-wrapper">
                    <a class="navbar-brand" style="color:#ff6600 ;" href="quanlythanhtoan.html">Danh sách thanh toán</a>
                    <a style="color:black  ;" href="themloaithanhtoan.html">Thêm loại thanh toán</a>
                </div>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header card-header-primary">
                                <h4 class="card-title ">Danh sách loại thanh toán</h4>
                            ...
                            <div class="card">
                                    ...
                                    <div id="table" class="table-editable">
                                        ...
                                        <table id="bang1" class="table table-bordered table-responsive-md table-striped text-center">
                                            ...
                                            <tr>
                                                ...
                                                <td class="pt-3-half" contenteditable="true">Thanh toán qua thẻ ATM</td>
                              ...
                              <span class="table-remove"><button type="button"
                                            ...
                                            <tr>
                                                ...
                                                <td class="pt-3-half" contenteditable="true">Thanh toán khi nhận hàng</td>
                              ...
                              <span class="table-remove"><button type="button"
                                            ...
                                            <tr>
                                                ...
                                                <td class="pt-3-half" contenteditable="true">Thanh toán qua ví momo</td>
                                                <td class="pt-3-half" contenteditable="true">27/7/2020</td>
