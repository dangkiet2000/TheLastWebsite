        ...
        <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
            <div class="container-fluid">
                <div class="navbar-wrapper">
                    <a  class="navbar-brand" href="quanlydanhgia.html">Danh sách Loai đánh giá</a>
                    <a href="themtheloai.html" style="color: #ff6600;">Thêm loại đánh giá</a>
                </div>
                    ...
                    <div class="col-md-8">
                        <div class="card">
                            <div class="card-header card-header-primary">
                                <h4 class="card-title">Thêm Loại đánh giá</h4>
                            ...
                            <div class="card-body">
                                <form>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="bmd-label-floating">Nhập loại đánh giá</label>
                                                <input type="text" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                            </div>
                            <button style="    margin-right: 351px;
                    margin-left: 348px;" type="submit" class="btn btn-primary pull-right">Thêm</button>
