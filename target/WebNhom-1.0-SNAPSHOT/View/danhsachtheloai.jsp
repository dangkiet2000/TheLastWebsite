...
<html>
<head>
    <script type="text/javascript" src="admin/examples/danhsach.js"></script>
        ...
        <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
            <div class="container-fluid">
                <div class="navbar-wrapper">
                    <a class="navbar-brand" style="color:#ff6600 ;" href="admin/examples/danhsachtheloai.html">Danh sách danh mục</a>
                    <a style="color:black  ;" href="admin/examples/themtheloai.html">Thêm danh mục</a>
                </div>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header card-header-primary">
                                <h4 class="card-title ">Danh sách loại danh mục</h4>
                                ...
                                <div class="card-body">
                                    <div id="table" class="table-editable">
                                        ...
                                        <table id="bang1" class="table table-bordered table-responsive-md table-striped text-center">
                                            ...
                                            <tbody>
                                            <c:forEach items="${DM}" var="m">
                                            <tr>
                                                <td class="pt-3-half" contenteditable="true">"${m.id}"</td>
