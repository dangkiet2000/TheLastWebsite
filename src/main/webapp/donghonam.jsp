            ...
            <div class="col-md-9 prdt-left">
                <div class="product-one">
                    <div>
                        ...
                        <img class="hinhdongho" src="images/banner-Casio.png" >
                        <div class="vanban">
                            <p>“Đồng hồ Casio được biết đến là thương hiệu đồng hồ lâu đời trong ngành công nghiệp đồng hồ tại Nhật Bản. Những mẫu đồng hồ Casio nam và đồng hồ Casio nữ được yêu thích bởi thiết kế đơn giản, dễ dàng để xem giờ, được trang bị đầy đủ các công nghệ mới nhất và có giá bán cực kỳ rẻ. Ngoài ra, đồng hồ Casio chính hãng còn nổi bật với chức năng đa dạng giúp ích cho người dùng vào những hoạt động đời sống thường ngày. Hãy lựa chọn ngay những mẫu đồng hồ Casio chính hãng bạn yêu thích nhất tại Đồng Hồ Hải Triều nhé!”</p>
                        </div>
                    </div>
