                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="card card-stats">
                            <div class="card-header card-header-warning card-header-icon">
                                ...
                                <p class="card-category">Không gian người dùng</p>
                            ...
                            <div class="card-footer">
                                <div class="stats">
                                    ...
                                    <a href="javascript:;">Thêm không gian</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="card card-stats">
                            <div class="card-header card-header-danger card-header-icon">
                                ...
                                <p class="card-category">Xử lý lỗi</p>
                                <h3 class="card-title">75</h3>
                            </div>
                            <div class="card-footer">
                                <div class="stats">
                                    <i class="material-icons">local_offer</i> Được theo dõi từ github
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="card card-stats">
                            <div class="card-header card-header-info card-header-icon">
                                ...
                                <p class="card-category">Người theo dõi</p>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="card card-chart">
                            ...
                            <div class="card-body">
                                <h4 class="card-title">Doanh số hàng ngày</h4>
                                <p class="card-category">
                                    <span class="text-success"><i class="fa fa-long-arrow-up"></i> 55% </span> tăng doanh số</p>
                            </div>
                            <div class="card-footer">
                                <div class="stats">
                    ...
                    <div class="col-md-4">
                        <div class="card card-chart">
                            ...
                            <div class="card-body">
                                <h4 class="card-title">Đăng ký email</h4>
                                <p class="card-category">Hiệu suất cuối cùng</p>
                            </div>
                            <div class="card-footer">
                                <div class="stats">
                                    <i class="material-icons">access_time</i> Hiệu suất 2 ngày trước
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="card card-chart">
                            ...
                            <div class="card-body">
                                <h4 class="card-title">Hoàn thành nhiệm vụ</h4>
                                <p class="card-category">Hiệu suất cuối cùng</p>
                            </div>
                            <div class="card-footer">
                                <div class="stats">
