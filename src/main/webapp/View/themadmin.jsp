        ...
        <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
            <div class="container-fluid">
                <div class="navbar-wrapper">
                    <a class="navbar-brand" href="danhsachadmin.html">Danh sách admin</a>
                    <a href="themadmin.html" style="color:#ff6600;">Thêm  admin</a>
                </div>
                            ...
                            <div class="card-body">
                                <form>
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="bmd-label-floating">Nhập mã admin</label>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="bmd-label-floating">Nhập tên admin</label>
                                                <input type="text" class="form-control">
                                            </div>
                                        </div>
                                    </div>
