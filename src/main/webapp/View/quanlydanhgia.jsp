        ...
        <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
            <div class="container-fluid">
                <div class="navbar-wrapper">
                    <a class="navbar-brand" style="color:#ff6600 ;" href="quanlydanhgia.html">Danh sách loại đánh giá</a>
                    <a style="color:black  ;" href="themloaidanhgia.html">Thêm loại đánh giá</a>
                </div>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header card-header-primary">
                                <h4 class="card-title ">Danh sách loại đánh giá</h4>
                            ...
                            <div class="card">
                                    ...
                                    <div id="table" class="table-editable">
                                        ...
                                        <table id="bang1" class="table table-bordered table-responsive-md table-striped text-center">
                                            ...
                                            <tr>
                                                ...
                                                <th class="text-center">Loại đánh giá</th>
                                            ...
                                            <tr>
                                                ...
                                                <td class="pt-3-half" contenteditable="true">5 sao (rất tốt)</td>
                              ...
                              <span class="table-remove"><button type="button"
                                            ...
                                            <tr>
                                                ...
                                                <td class="pt-3-half" contenteditable="true">4 sao (tốt)</td>
                              ...
                              <span class="table-remove"><button type="button"
                                            ...
                                            <tr>
                                                ...
                                                <td class="pt-3-half" contenteditable="true">3 sao (bình thường)</td>
