        ...
        <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
            <div class="container-fluid">
                <div class="navbar-wrapper">
                    <a class="navbar-brand" href="quanlythanhtoan.html">Danh sách loại thanh toán</a>
                    <a href="themloaithanhtoan.html" style="color: #ff6600;">Thêm loại thanh toán</a>
                </div>
                    ...
                    <div class="col-md-8">
                        <div class="card">
                            <div class="card-header card-header-primary">
                                <h4 class="card-title">Thêm loại thanh toán</h4>
