        ...
        <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
            <div class="container-fluid">
                <div class="navbar-wrapper">
                    <a class="navbar-brand" href="javascript:;">Thông tin cá nhân</a>
                </div>
                    ...
                    <div class="col-md-8">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form>
                                    <!-- <div>
                                      <div style="float: left;margin-left: 250px;margin-bottom: 20px;"> Họ tên:</div>
                                      <div style="float: right;margin-right: 250px;margin-bottom: 20px;">Đinh Thị Hằng</div>
                                    </div>
                                    <div>
                                      <div style="float: left;margin-left: 250px;margin-bottom: 20px;"> Ngày sinh:</div>
                                      <div style="float: right;margin-right: 250px;margin-bottom: 20px;">26/01/2000</div>
                                    </div>
                                    <div>
                                      <div style="float: left;margin-left: 250px;margin-bottom: 20px;"> Địa chỉ mail:</div>
                                      <div style="float: right;margin-right: 250px;margin-bottom: 20px;">dinhthihang@gmail.com</div>
                                    </div>
                                    <div>
                                      <div style="float: left;margin-left: 250px;"> Điện thoại:</div>
                                      <div style="float: right;margin-right: 250px;">0888243741</div>
                                    </div> -->
                                    <div style="float: left;">
                                        <img style="border-radius: 50%;" class="img" width="350px" height="400px " src="../assets/img/faces/128041140_376793233584875_3391161761297757847_n.jpg" />
                                    </div>
                                    ...
                                    <button style="float: left; margin-top: 100px;" type="submit" class="btn btn-primary pull-right">Chỉnh sửa</button>
